...
type Organization struct {
	...
	Users       []user.User             `json:"users" gorm:"constraint:OnDelete:CASCADE,OnUpdate:CASCADE;"`       // Added constraint for user deletion
	Candidates  []candidate.Candidate   `json:"candidates" gorm:"constraint:OnDelete:CASCADE,OnUpdate:CASCADE;"`  // Added constraint for candidate deletion
	Assessments []assessment.Assessment `json:"assessments" gorm:"constraint:OnDelete:CASCADE,OnUpdate:CASCADE;"` // Added constraint for assessment deletion
}
